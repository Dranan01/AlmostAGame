 ...
 * @author franm
 */
public class SkeletonEnemie extends Image {
    TextureRegion jump,stand;
    Animation walk;
    ...
    public SkeletonEnemie() {
        final float width = 47;
        final float height = 47;
        this.setSize(1, height / width);

        Texture knightTexture = new Texture("SkeletonEnemy.png");
